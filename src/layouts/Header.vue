...
<template>
    ...
    <div class="container mx-auto px-5">
        <header class="flex justify-between py-12 items-center">
            <div>
                <a href="/"><img class="h-20 w-100" src="/images/pronor.png" alt="Site Logo"></a>
            </div>
            ...
            <nav class="flex justify-end flex-col md:flex-row">
                ...
                <ul class="space-x-10 font-theme-heading font-medium items-center hidden md:flex  flex-col space-y-7 md:space-y-0 md:flex-row">
                    ...
                    <li class="uppercase hover:text-theme-secondary transition duration-200"><a href="#faq" v-smooth-scroll>Services</a></li>
                    <li class="uppercase hover:text-theme-secondary transition duration-200"><a href="#subscribe" v-smooth-scroll>About Us</a></li>
                  <li class="uppercase hover:text-theme-secondary transition duration-200"><a href="#subscribe" v-smooth-scroll>Contact Us</a></li>
                  <li class="uppercase hover:text-theme-secondary transition duration-200"><a href="#subscribe" v-smooth-scroll>Slide Us</a></li>
                  <li class="uppercase hover:text-theme-secondary transition duration-200"><a href="#subscribe" v-smooth-scroll>Fax Service</a></li>
                  <li class="uppercase hover:text-theme-secondary transition duration-200"><a href="#subscribe" v-smooth-scroll>Global</a></li>
                </ul>
            </nav>
        </header>
        ...
        <div v-show="mobileNav">
            <div class="absolute px-5 py-12 block z-30 top-0 left-0 w-full h-full bg-gradient-to-b from-theme-dark-blue via-theme-dark-blue-tp to-theme-dark-blue">
                <div class="flex justify-between items-center">
                    <img class='h-10' src="/images/pronor.png" alt="Logo">
                ...
                <ul class="uppercase text-white text-md tracking-widest items-center flex flex-col mt-14">
                    <li class="hover:text-theme-secondary transition duration-200 py-4 border-t border-b border-theme-grayish-blue w-full text-center">
                        <a  @click="toggleMobileNav()" href="#features">Home</a>
                    </li>
                    <li class="hover:text-theme-secondary transition duration-200 py-4 border-b border-theme-grayish-blue w-full text-center">
                        <a  @click="toggleMobileNav()" href="#faq">Service</a>
                    </li>
                    <li class="hover:text-theme-secondary transition duration-200 py-4 border-b border-theme-grayish-blue w-full text-center">
                        <a  @click="toggleMobileNav()" href="#subscribe">About Us</a>
                    </li>
                  <li class="hover:text-theme-secondary transition duration-200 py-4 border-b border-theme-grayish-blue w-full text-center">
                    <a  @click="toggleMobileNav()" href="#subscribe">Contact Us</a>
                  </li>
                  <li class="hover:text-theme-secondary transition duration-200 py-4 border-b border-theme-grayish-blue w-full text-center">
                    <a  @click="toggleMobileNav()" href="#subscribe">Slide Us</a>
                  </li>
                  <li class="hover:text-theme-secondary transition duration-200 py-4 border-b border-theme-grayish-blue w-full text-center">
                    <a  @click="toggleMobileNav()" href="#subscribe">Fax Service</a>
                  </li>
                  <li class="hover:text-theme-secondary transition duration-200 py-4 border-b border-theme-grayish-blue w-full text-center">
                    <a  @click="toggleMobileNav()" href="#subscribe">Global</a>
                  </li>
                </ul>
